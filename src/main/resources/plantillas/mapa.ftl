...
<@base.pagina>
    ...
    <script type='text/javascript' src='https://maps.googleapis.com/maps/api/js?key=AIzaSyBcw0xUh2SCzhGa6y4z1NmK3qLbBvXeNxY'></script>
    <script>
        function initialize() {
    ...
    <div id="mapa" class="mx-auto mt-3"></div>
    <table class="mt-3 table table-hover bg-primary text-white table-responsive-sm">
        <thead>
        <tr>
            <th>Nombre</th>
            <th>Sector</th>
